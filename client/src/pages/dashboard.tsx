    ...
    >
      ...
      >
        <div className="flex items-center justify-center gap-3">
          <div className="w-12 h-12 rounded-lg shadow-md border-2 border-white flex items-center justify-center" style={{ backgroundColor: 'rgba(255, 213, 220, 0.4)' }}>
      ...
      {/* User Info Bar */}
      <div className="px-4 py-2 flex justify-between items-center" style={{ background: 'rgba(255, 213, 220, 0.4)', borderBottom: '1px solid rgba(243, 198, 212, 0.3)' }}>
