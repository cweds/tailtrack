              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="flex items-center justify-center w-full text-sm border-2 rounded-lg px-3 py-3 md:pl-3 md:pr-3 pl-10 pr-10 border-blue-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 bg-white text-gray-900 cursor-pointer shadow-sm font-medium md:[&::-webkit-calendar-picker-indicator]:inline [&::-webkit-inner-spin-button]:hidden [&::-webkit-clear-button]:hidden"
                    style={{ fontSize: '16px' }}
                  />
