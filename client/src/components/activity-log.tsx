    ...
    <div className="bg-white p-4 rounded-xl shadow-sm border border-orange-200">
      ...
      {editingId && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-blue-50 rounded-lg p-6 w-full max-w-md shadow-xl max-h-[90vh] overflow-y-auto">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="flex items-center justify-center w-full text-sm border-2 rounded-lg pl-10 pr-10 py-3 border-blue-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 bg-white text-gray-900 cursor-pointer shadow-sm font-medium"
                    style={{ fontSize: '16px' }}
                  />
