              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full text-sm border-2 rounded-lg px-3 py-3 border-blue-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 bg-white text-gray-900 shadow-sm font-medium"
                    style={{ fontSize: '16px' }}
                  />
                </div>
              </div>
