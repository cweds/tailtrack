  ...
  return (
    <div className="space-y-3">
      <Button
        ...
        disabled={!canFeed}
        className="w-full pup-pink-gradient disabled:bg-gray-300 disabled:cursor-not-allowed text-gray-800 font-medium py-4 px-6 rounded-xl paw-shadow playful-bounce disabled:transform-none disabled:filter-none disabled:shadow-none h-auto"
      >
      ...
      <Button
        ...
        disabled={!canLetOut}
        className="w-full soft-blue-gradient disabled:bg-gray-300 disabled:cursor-not-allowed text-gray-800 font-medium py-4 px-6 rounded-xl paw-shadow playful-bounce disabled:transform-none disabled:filter-none disabled:shadow-none h-auto"
      >
        <span className="flex items-center justify-center gap-2">
          <span className="text-lg">🚪</span>
